		...
		$.ajax({
			...
			success:function(result){
							...
							if (result.status == 'error'){
								...
								oneresult.text(380, 10, "鎮ㄦ煡璇㈢殑缂栫爜").attr({'font-family':'寰蒋闆呴粦','font-size':'20px','fill':'#777'});
								...
								oneresult.text(380,250,"灞炰簬"+result.data).attr({'font-family':'寰蒋闆呴粦','font-size':'20px','fill':'#777'});
								oneresult.text(380,270,fullName).attr({'font-family':'寰蒋闆呴粦','font-size':'15px','fill':'#777'});
								oneresult.text(380,290,codeNum).attr({'font-family':'寰蒋闆呴粦','font-size':'15px','fill':'#777'});
							}
							else if (result.status >1){
